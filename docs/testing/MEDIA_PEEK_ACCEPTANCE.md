...
| `NH-MEDIA-PEEK-005` | Explicit expansion | Free-surface click and physical DOWN from Peek each open expanded exactly once; compact click also explicitly expands even while hover/media state changes during the click. | Root-ownership RED #1153 -> GREEN #1155; first-mouse + settled/press-aware probe repair; #1196 external XCUI 11/11 + 10-cycle stress GREEN | PENDING |
