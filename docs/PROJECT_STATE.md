...
Accepted target-Mac runtime baseline against Personal Release `v0.1.0` on macOS 26.6 / `Mac16,8`:
...
RED CI #91 failed exactly because the size-comparison API was absent. GREEN CI #94 passed 22 performance-policy tests, security/build/package gates, the deterministic size gate, harness smoke, and artifact upload.
