...
1. Run the short revised target-Mac acceptance matrix above using the latest exact-head CI artifact, with special emphasis on visible black compact chrome and `NH-VISUAL-003` repeated-cycle stability, and record results honestly.
