...
public struct ProductionMediaTransportCandidateBundlePaths: Equatable, Sendable {
    ...
    public static func resolve(bundleURL: URL, resourceURL: URL?, sourceCommit: String?) throws -> Self {
        ...
        guard normalizedBundleURL.pathExtension == "app",
              let resourceURL,
        ...
        return Self(
            scriptURL: expectedResourceURL.appendingPathComponent("mediaremote-adapter.pl"),
            frameworkURL: expectedResourceURL.appendingPathComponent("MediaRemoteAdapter.framework", isDirectory: true),
